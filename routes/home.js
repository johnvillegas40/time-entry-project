...
router.post("/", middleware.isLoggedIn, function(req, res) {
    ...
    var newTimeEntry = {date: date, ftcn: ftcn, description: description, author:author, cust: cust, billcode: billcode, job: job, agr: agr, time: time, totaltime: totaltime, mco: mco}
...
router.get("/:date/:id/edit", middleware.checkTimeEntryOwnership, function(req, res) {
...
router.put("/:date/:id", middleware.checkTimeEntryOwnership, function(req, res){
    ...
    TimeEntry.findByIdAndUpdate(req.params.id, req.body.timeEntry, function(err, updatedTimeEntry){
        if(err){
            res.redirect("/home");
        } else {
...
router.delete("/:date/:id", middleware.checkTimeEntryOwnership, function(req, res){
